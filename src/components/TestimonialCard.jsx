...
const TestimonialCard = ({ text, shareImg, rating, personImg, name, source }) => {
    return (
        <div className='max-w-[380px] min-h-full max-h-full h-full rounded-lg shadow-md bg-[#F9F0F8] p-5'>
            <p>
                {text}
            </p>
            <div className='flex gap-4 items-center mt-4'>
                <span className='bg-white shadow-md p-1 rounded-lg'><img src={shareImg} alt="share" /></span>
            ...
            <div className='mt-auto py-4 border-t border-[#7A7A7A]'>
